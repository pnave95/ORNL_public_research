...
<inventory>
    ...
    <component name="arcs_moderator2sample">
        ...
        <property name="post-processing-scripts-dir">/tmp/tmpBaTb4d/post-processing-scripts</property>
...
<!-- Generated automatically by Renderer on Mon Apr  3 13:07:56 2017-->

<!-- End of file -->
<!-- 
 automatically created by the following command:
 $ simapp.py -dump-pml=yes -h -fermichopper.tc=0.00237893924785 -t0chopper.nu=60.0 -fermichopper.nu=600.0 -moderator.Emin=100.0 -geometer.fermichopper=((0, 0, 11.61), (0, 0, 180)) -fermichopper=fermichopper-100-1.5-SMI -geometer.moderator=((0, 0, 0), (0, -13.75, 0)) -t0chopper.tc=0.00179818660652 -moderator.angling=-13.75 -moderator.Emax=150.0 -post-processing-scripts-dir=/tmp/tmpBaTb4d/post-processing-scripts
-->
