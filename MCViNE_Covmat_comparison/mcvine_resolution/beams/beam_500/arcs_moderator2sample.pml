...
<inventory>
    ...
    <component name="arcs_moderator2sample">
        ...
        <property name="post-processing-scripts-dir">/tmp/tmpUJsFLU/post-processing-scripts</property>
...
<!-- Generated automatically by Renderer on Sun Apr  9 10:19:03 2017-->

<!-- End of file -->
<!-- 
 automatically created by the following command:
 $ simapp.py -dump-pml=yes -h -fermichopper.tc=0.00118900768677 -t0chopper.nu=60.0 -fermichopper.nu=600.0 -moderator.Emin=400.0 -geometer.fermichopper=((0, 0, 11.61), (0, 0, 180)) -fermichopper=fermichopper-100-1.5-SMI -geometer.moderator=((0, 0, 0), (0, -13.75, 0)) -t0chopper.tc=0.000898631366108 -moderator.angling=-13.75 -moderator.Emax=600.0 -post-processing-scripts-dir=/tmp/tmpUJsFLU/post-processing-scripts
-->
