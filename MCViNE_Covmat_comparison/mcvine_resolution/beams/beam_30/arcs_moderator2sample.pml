...
<inventory>
    ...
    <component name="arcs_moderator2sample">
        ...
        <property name="post-processing-scripts-dir">/tmp/tmpDWqdSb/post-processing-scripts</property>
...
<!-- Generated automatically by Renderer on Sun Apr  9 10:17:56 2017-->

<!-- End of file -->
<!-- 
 automatically created by the following command:
 $ simapp.py -dump-pml=yes -h -fermichopper.tc=0.0048595430485 -t0chopper.nu=60.0 -fermichopper.nu=600.0 -moderator.Emin=24.0 -geometer.fermichopper=((0, 0, 11.61), (0, 0, 180)) -fermichopper=fermichopper-100-1.5-SMI -geometer.moderator=((0, 0, 0), (0, -13.75, 0)) -t0chopper.tc=0.00367408668348 -moderator.angling=-13.75 -moderator.Emax=36.0 -post-processing-scripts-dir=/tmp/tmpDWqdSb/post-processing-scripts
-->
