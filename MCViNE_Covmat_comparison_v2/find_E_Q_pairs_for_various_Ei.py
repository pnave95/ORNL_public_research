#  The purpose of this script is to find valid E,Q points for different Ei's.  This script computes multiple points for multiple Ei values to be used in comparing the correlation / covariance matrix method and MCViNE simulation method for analyzing ARCS resolution effects.

# NOTE:  This script seems to have a problem somewhere.  In particular, when hkl0 = [0, 0, 0] and hkl_dir = [1, 0, 0], the script works.  However, for every other case I have tried, the script fails for every value of Ei.  I am not sure why this is happening.
...
def compute_E_dq_pairs(Ei, hkl0, hkl_dir, verbose=False, sample_yml='./Si.yml'):
    ...
    fractions = [0.9, 0.85, 0.8, 0.75, 0.7, 0.65, 0.6, 0.55, 0.5, 0.45, 0.4, 0.35, 0.3, 0.25, 0.2, 0.15, 0.1, 1./16, 1./32, 1./64, 1./128]
    Eq_pairs = []
    for f in fractions:
        E = f*Ei
        #print 'E=', E
